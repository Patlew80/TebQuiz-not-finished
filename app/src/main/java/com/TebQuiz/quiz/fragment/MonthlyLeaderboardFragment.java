package com.TebQuiz.quiz.fragment;
...
import com.TebQuiz.quiz.activity.LeaderboardAdapter;
...
import com.TebQuiz.quiz.helper.UserSessionManager;
import com.TebQuiz.quiz.helper.Utils;
import com.TebQuiz.quiz.model.LeaderBoard;
import com.TebQuiz.quiz.model.Model;
...
import static com.TebQuiz.quiz.Constant.PAGE_LIMIT;
...
public class MonthlyLeaderboardFragment extends Fragment {
    ...
    public void LeaderBoardData(final String date, final String type, final int startoffset) {
            ...
            if (Utils.isNetworkAvailable(getActivity())) {
                ...
                params.put(Constant.getMonthlyLeaderboard, "1");
                                        ...
                                        adapter.setOnLoadMoreListener(() -> {
                                            ...
                                            if (lbList.size() < total) {
                                                ...
                                                new Handler().postDelayed(() -> {
                                                    ...
                                                    params1.put(Constant.getMonthlyLeaderboard, "1");
