...
import com.TebQuiz.quiz.model.LuckyItem;
...
public class PielView extends View {
    ...
    /*        if (mLuckyItemList.get(i).icon.equals(null))
    ...
    private void drawSecondaryText(Canvas canvas, float tmpAngle, String mStr, int backgroundColor) {
        ...
        int x = (int) (mCenter + mRadius / 2.5 / 2.5 * Math.cos(angle));
        int y = (int) (mCenter + mRadius / 2.5 / 2.5 * Math.sin(angle));
