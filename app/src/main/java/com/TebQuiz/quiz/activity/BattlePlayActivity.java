...
import com.TebQuiz.quiz.helper.CircleTimer;
import com.TebQuiz.quiz.helper.Session;
import com.TebQuiz.quiz.helper.TouchImageView;
import com.TebQuiz.quiz.helper.Utils;
import com.TebQuiz.quiz.model.Question;
...
public class BattlePlayActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView p2ans_a, p2ans_b, p2ans_c, p2ans_d, p2ans_e, tvPlayer1Name, tvPlayer2Name, btnQuitGame, tvIndex;
    ArrayList<String> options;
    
    Handler mHandler = new Handler();
    Question question;
    Animation animation,RightSwipe_A, RightSwipe_B, RightSwipe_C, RightSwipe_D, RightSwipe_E, Fade_in;
    CircleImageView imgPlayer1, imgPlayer2;
    DatabaseReference myGameRef;
    ImageView imgZoom;
    RelativeLayout playLayout, layout_A, layout_B, layout_C, layout_D, layout_E;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation = AnimationUtils.loadAnimation(activity, R.anim.right_ans_anim);
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    if (snapshot.child(Constant.LEFT_BATTLE).exists()) {
                                        ...
                                        if (p1_que[0] == p2_que[0]) {
                                            ...
                                            if (p1_que[0] == questionList.size()) {
                                                if (attendedQue == questionList.size()) {
...
public void getAllWidgets(){
        ...
        try {
            ...
            tvShare.setOnClickListener(view -> {
                ...
                if (winner.equals("you")) {
                    shareMsg = getString(R.string.wonagaines) + Player2Name;
                } else {
                    shareMsg = getString(R.string.lostagainest) + Player2Name;
    ...
    private void nextQuizQuestion() {
        ...
        if (questionIndex < questionList.size()) {
            ...
            index = getString(R.string.index) + questionIndex;
